...
<body background = "images/bg.png" onload="myalert()">
<script>
function myalert()
{
	<%
  ...
  <form action="SignUp" method="post">
    ...
    <p>  <input type="text" placeholder="Enter Address" name="saddress" required>
    <p>  <label><b><font color="#FA4553">Mobile No</font></b></label>
    <p>  <input type="text" placeholder="Enter Mobile No" name="scontact" required>
